...
1. **Built on what exists.** Zil composes with ADK, MCP, DeepEval, OpenTelemetry, and [others](/technologies). We do not reinvent agent orchestration, tool protocols, evaluation, or telemetry.
