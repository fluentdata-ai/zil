...
ADK then automatically emits spans for agent invocations, LLM calls, and tool executions — following the [OpenTelemetry GenAI Semantic Conventions](https://github.com/open-telemetry/semantic-conventions/blob/main/docs/gen-ai/gen-ai-agent-spans.md).
