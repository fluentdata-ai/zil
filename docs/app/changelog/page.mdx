...
## [0.1.21](https://github.com/fluentdata-co/zil/compare/v0.1.20...v0.1.21) — 2026-06-16
...
- **[A2A Collaboration](/collaboration) docs** — a dedicated documentation page covering the caller/callee roles, collaborator declaration, discovery modes, inter-agent auth, context transfer, the native `A2APeerClient`, topology, validation, and fleet deployment.
...
## [0.1.20](https://github.com/fluentdata-co/zil/compare/v0.1.19...v0.1.20) — 2026-06-02
...
## [0.1.19](https://github.com/fluentdata-co/zil/compare/v0.1.18...v0.1.19) — 2026-05-26
...
- **SSE token_usage visibility** — `zil serve` now surfaces `token_usage` at the top level of the SSE `done` event payload so downstream consumers can read it directly.
...
## [0.1.18](https://github.com/fluentdata-co/zil/compare/v0.1.17...v0.1.18) — 2026-05-25
...
## [0.1.17](https://github.com/fluentdata-co/zil/compare/v0.1.16...v0.1.17) — 2026-05-23
...
- **Documentation overhaul** — three new doc pages ([Multi-Agent & HITL](/multi-agent), [Skills](/skills), [Runtime Dependencies](/runtime-deps)) and comprehensive updates to CLI reference, SDK reference, introduction, getting-started, and MCP tools pages covering all features from 0.1.14–0.1.16. Refreshed `agent-content.txt` agent-friendly reference.

## [0.1.16](https://github.com/fluentdata-co/zil/compare/v0.1.15...v0.1.16) — 2026-05-22
...
## [0.1.15](https://github.com/fluentdata-co/zil/compare/v0.1.14...v0.1.15) — 2026-05-21
...
## [0.1.14](https://github.com/fluentdata-co/zil/compare/v0.1.13...v0.1.14) — 2026-05-20

### Added

- **Generic `tools/` convention** — external tool dependencies (MCP servers, CLI tools, binaries) live under `tools/{name}/` in the project directory. Bundled into archives and Docker images during pack/deploy. See [MCP Tools](/tools).
...
## [0.1.13](https://github.com/fluentdata-co/zil/compare/v0.1.12...v0.1.13) — 2026-05-19

### Added

- **MCP server integration** — declare MCP servers in `spec.tools.mcp_servers` with stdio/SSE transport, env var resolution, tool filters, and timeouts. See [MCP Tools](/tools).
...
## [0.1.12](https://github.com/fluentdata-co/zil/compare/v0.1.11...v0.1.12) — 2026-05-15
...
## [0.1.11](https://github.com/fluentdata-co/zil/compare/v0.1.10...v0.1.11) — 2026-05-13

### Added

- **[Token-based cost tracking](/cost)** — new `spec.cost` manifest section for declaring token budgets (`max_tokens_per_request`, `max_tokens_per_session`, `alert_threshold_pct`, `track_by_model`). The SDK tracks raw token counts; dollar pricing is purposefully left out of the SDK for flexibility. 
The vision is that there will be an external service (part of the runtime) that can convert token counts to dollar amounts.

- **`zil.cost` singleton** — module-level cost tracker: `zil.cost.total_tokens`, `zil.cost.by_model`, `zil.cost.budget_remaining`, `zil.cost.reset()`.
- **`CostTracker` class** — thread-safe token usage accumulator with per-request and per-session budget enforcement.
...
- **`create_agent(enable_cost_tracking=True)`** — automatically initializes cost tracking from `spec.cost`.
- **`zil validate` cost checks** — warns if `spec.cost` is absent, flags budget inconsistencies.
- **`zil inspect` cost display** — shows budget configuration from archived manifests.
- **[`zil pack --sign`](/signing)** — signs the `.zil` archive using cosign (keyless/Sigstore OIDC by default). Produces a Sigstore `.bundle` file.
- **`zil pack --sign --key <path>`** — key-based cosign signing for CI environments.
- **`zil inspect --verify`** — verifies the cosign signature of a `.zil` archive.
- **`zil push` signature attachment** — automatically pushes the `.bundle` alongside the OCI artifact.
- 45 new tests; 295 total tests.

## [0.1.10](https://github.com/fluentdata-co/zil/compare/v0.1.9...v0.1.10) — 2026-05-12
...
## [0.1.9](https://github.com/fluentdata-co/zil/compare/v0.1.8...v0.1.9) — 2026-05-12
...
## [0.1.8](https://github.com/fluentdata-co/zil/compare/v0.1.7...v0.1.8) — 2026-05-11
...
## [0.1.7](https://github.com/fluentdata-co/zil/compare/v0.1.6...v0.1.7) — 2026-05-08
...
## [0.1.6](https://github.com/fluentdata-co/zil/compare/v0.1.5...v0.1.6) — 2026-05-07
...
## [0.1.5](https://github.com/fluentdata-co/zil/compare/v0.1.4...v0.1.5) — 2026-05-06
...
## [0.1.4](https://github.com/fluentdata-co/zil/compare/v0.1.3...v0.1.4) — 2026-05-05
...
## [0.1.3](https://github.com/fluentdata-co/zil/compare/v0.1.2...v0.1.3) — 2026-05-05
...
## [0.1.2](https://github.com/fluentdata-co/zil/compare/v0.1.1...v0.1.2) — 2026-05-04
...
## [0.1.1](https://github.com/fluentdata-co/zil/compare/v0.1.0...v0.1.1) — 2026-05-02
...
## [0.1.0](https://github.com/fluentdata-co/zil/releases/tag/v0.1.0) — 2026-04-30
